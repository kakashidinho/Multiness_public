...
-(id)initWithTextField:(UITextField *)tf withData:(NSArray*) data
{
    ...
    if (self) {
		...
		if (img == nil) img = [UIImage imageNamed:@"DownPicker.framework/DownPicker.bundle/downArrow.png"]; // inside framework
		if (img == nil) img = [UIImage imageNamed:@"Frameworks/DownPicker.framework/DownPicker.bundle/downArrow.png"]; // inside framework 2
