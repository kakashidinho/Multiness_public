...
namespace Nestopia
{
	...
	namespace Managers
	{
		...
		private:
			...
			void OnCmdToggleRemoteController1(uint params);//LHQ
			void OnCmdToggleRemoteController2(uint params);//LHQ
			bool OnCmdToggleRemoteController(uint id, uint params);//LHQ
			...
			Commands commands;
			Clipboard clipboard;
			uint abPressedState[4];//LHQ

			std::map<uint, uint> remoteMenuItemId2ControllerIds;//LHQ
			int remotePort;//LHQ
			String::Heap<char> natServerAddr;
			int natServerPort;
