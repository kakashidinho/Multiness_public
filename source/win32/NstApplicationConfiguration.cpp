...
namespace Nestopia
{
	namespace Application
	{
		...
		int Configuration::GetRemotePort() const {
			//TODO: configurable
			return 23458;
		}

		const char* Configuration::GetNATServerAddress() const
		{
			//TODO: configurable.
                       // Use your server address. This server could be closed at anytime.
			return "125.212.218.120";
		}
		int Configuration::GetNATServerPort() const
		{
			//TODO: configurable
			return 61111;
		}
