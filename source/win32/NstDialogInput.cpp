...
namespace Nestopia
{
	namespace Window
	{
		...
		const Input::Settings::Mapping Input::Settings::map[NUM_KEYS] =
		{
			...
			{ PAD1_KEYS + PAD_KEY_AB,			NO_KEY,	  IDS_INPUT_PAD_KEY_AB,			"pad-1", "ab"		   },
			{ PAD1_KEYS + PAD_KEY_AUTOFIRE_AB,	NO_KEY,	  IDS_INPUT_PAD_KEY_AUTOFIRE_AB,"pad-1", "auto-fire-ab" },
			...
			{ PAD2_KEYS + PAD_KEY_AB,			NO_KEY,	  IDS_INPUT_PAD_KEY_AB,			"pad-2", "ab" },
			{ PAD2_KEYS + PAD_KEY_AUTOFIRE_AB,	NO_KEY,	  IDS_INPUT_PAD_KEY_AUTOFIRE_AB,"pad-2", "auto-fire-ab" },
			...
			{ PAD3_KEYS + PAD_KEY_AB,			NO_KEY,	  IDS_INPUT_PAD_KEY_AB,			"pad-3", "ab" },
			{ PAD3_KEYS + PAD_KEY_AUTOFIRE_AB,	NO_KEY,	  IDS_INPUT_PAD_KEY_AUTOFIRE_AB,"pad-3", "auto-fire-ab" },
			...
			{ PAD4_KEYS + PAD_KEY_AB,			NO_KEY,	  IDS_INPUT_PAD_KEY_AB,			"pad-4", "ab" },
			{ PAD4_KEYS + PAD_KEY_AUTOFIRE_AB,	NO_KEY,	  IDS_INPUT_PAD_KEY_AUTOFIRE_AB,"pad-4", "auto-fire-ab" },
