...
namespace Nestopia
{
	namespace Managers
	{
		...
		public:
			...
			bool LoadRemote(const String::Heap<char>& remoteIp, int remotePort);
			bool LoadRemote(std::shared_ptr<HQRemote::IConnectionHandler> connHandler, const char* myName = 0);
			bool EnableRemoteController(uint idx, int networkListenPort);
			bool EnableRemoteController(uint idx, std::shared_ptr<HQRemote::IConnectionHandler> connHandler, const char* myName = 0);
			...
			bool Power(bool);
			void Execute(Nes::Video::Output*,Nes::Sound::Output*,Nes::Input::Controllers*,Nes::Sound::Input*);
