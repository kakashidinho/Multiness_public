...
namespace Nes
{
	namespace Api
	{
		...
		Result NST_FASTCALL Cheats::GameGenieEncode(const Code& code,char (&characters)[9]) throw()
		{
		...
		Result NST_FASTCALL Cheats::GameGenieDecode(const char* const characters,Code& code) throw()
		{
			if (characters == NULL)
				return RESULT_ERR_INVALID_PARAM;
		...
		Result NST_FASTCALL Cheats::ProActionRockyEncode(const Code& code,char (&characters)[9]) throw()
		{
		...
		Result NST_FASTCALL Cheats::ProActionRockyDecode(const char* const characters,Code& code) throw()
		{
			if (characters == NULL)
				return RESULT_ERR_INVALID_PARAM;
