	...
	namespace Api
	{
		...
		*/
		...
		public:
			...
			* @return result code
			*/
			static Result NST_FASTCALL GameGenieEncode(const Code& code,char (&string)[9]) throw();
			...
			* @return result code
			*/
			static Result NST_FASTCALL GameGenieDecode(const char* string,Code& code) throw();
			...
			* @return result code
			*/
			static Result NST_FASTCALL ProActionRockyEncode(const Code& code,char (&string)[9]) throw();
			...
			* @return result
			*/
			static Result NST_FASTCALL ProActionRockyDecode(const char* string,Code& code) throw();
		};
	}
}
