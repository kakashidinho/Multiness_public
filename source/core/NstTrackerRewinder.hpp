...
namespace Nes
{
	namespace Core
	{
		...
		{
			typedef void (Machine::*EmuExecute)(Video::Output*,Sound::Output*,Input::Controllers*,Sound::Input*);
		...
		public:
			...
			Result Start();
			Result Stop();
			void   Execute(Video::Output*,Sound::Output*,Input::Controllers*,Sound::Input*);
