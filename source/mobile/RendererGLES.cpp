...
namespace Nes
{
	namespace Video {
		namespace GL {
			...
			: m_videoTexture(nullptr), m_renderProgram(0), m_renderVBO(0), m_esVersionMajor(2),
			...
			void Renderer::DrawRect(float x, float y, float width, float height)
			{
				...
				glUniform4f(m_renderTransformUniformLoc, xNormalized, yNormalized, wScaled, hScaled);
